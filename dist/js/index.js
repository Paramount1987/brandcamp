...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_nav__ = __webpack_require__(25);
 // libs
//-------------------------------------------------------
...
__webpack_require__(4); // utils
//----------------------------------------------


__webpack_require__(15); // components
//----------------------------------------------
...
__WEBPACK_IMPORTED_MODULE_1__components_nav__["a" /* default */].init();
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_modernizr__ = __webpack_require__(17);
...
$('.js-multy-slider').each(function initSlider() {
  var el = this;
  var perViewLg = +$(el).data('perviewlg') || 4;
  var perViewMd = +$(el).data('perviewmd') || 3;
...
/* global Swiper */
var swiper = new Swiper('.js-pics-slider', {
  pagination: {
    el: '.swiper-pagination'
  }
});
...
$('.js-gallery-wrapper').each(function init() {
  var $wrapper = $(this);
  var $mainGallery = $wrapper.find('.js-pdct-gallery');
  var $verticalGallery = $wrapper.find('.js-pdct-vertical-gallery');
  var $verticalSlides = $verticalGallery.find('.swiper-slide');
  var $arrowVerticalPrev = $wrapper.find('.js-vertical-prev');
  var $arrowVerticalNext = $wrapper.find('.js-vertical-next');
  ...
  var verticalSwiper = new Swiper($verticalGallery, {
    direction: 'vertical',
    slidesPerView: 4,
    spaceBetween: 10
  ...
  $verticalSlides.click(function initClickSlide() {
    ...
    var currInd = $currSlide.data('rel');
    mainSwiper.slideTo(+currInd);
  }); //--------------------------------
  // click prev & next arrow

  $arrowVerticalPrev.click(function () {
    verticalSwiper.slidePrev();
  });
  $arrowVerticalNext.click(function () {
...
var Nav = {
  ...
  navLinkHandler: function navLinkHandler() {
  ...
  btnCatalogHandler: function btnCatalogHandler() {
    var self = this;
    this.$btnCatalog.click(function (e) {
      e.preventDefault();
